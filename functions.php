...
function custom_breadcrumbs() {
    ...
    // UPDATED: Point to your Categories page
    $all_categories_page_url = home_url('/categories/');
    ...
    if (!is_front_page()) {
        ...
        if (is_archive() && !is_tax() && !is_category() && !is_tag()) {
            ...
            if ($post_type == 'product' && function_exists('wc_get_product')) {
                ...
                // Link to your Categories page
                echo '<a href="' . esc_url($all_categories_page_url) . '" class="breadcrumb-item">Products</a>';
                echo '<span class="breadcrumb-separator">' . esc_html($separator) . '</span>';
